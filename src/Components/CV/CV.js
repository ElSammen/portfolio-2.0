...
function MeCV() {
  ...
  return (
    <Container className="cvPage">
      ...
      {(pageNumber != 1 ? <div className="prevButtonCV prevButton" onClick={() => setPageNumber(pageNumber - 1)}>⇦ Previous</div> : null)}
      ...
      {(pageNumber !== 3 ? <div className="nextButtonCV nextButton" onClick={() => setPageNumber(pageNumber + 1)}>Next ⇨</div> : <div className="returnButton "onClick={() => setPageNumber(1)}>Return ⟲</div>)}
    </Container>
